...
--
-- Database: `crypto_currency_market_financial_risk_management`
--
CREATE DATABASE IF NOT EXISTS `crypto_currency_market_financial_risk_management` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `crypto_currency_market_financial_risk_management`;
...
(2, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#7827,4th Cross,Vijayanagar', 'Male'),
(3, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#782,4th Cross,Malleshwaram', 'Male');
...
(9, 'Naive Bayes', '49.62406015037594'),
(10, 'SVM', '53.00751879699248'),
(11, 'Logistic Regression', '50.37593984962406'),
(12, 'Decision Tree Classifier', '52.63157894736842');
...
(13, 'No Risk Found', '66.66666666666666'),
(14, 'Risk Found', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_financial_risk_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_financial_risk_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `volume_usd_24h` varchar(3000) NOT NULL,
  `available_supply` varchar(3000) NOT NULL,
  `idn` varchar(3000) NOT NULL,
  `last_updated` varchar(3000) NOT NULL,
  `market_cap_usd` varchar(3000) NOT NULL,
  `max_supply` varchar(3000) NOT NULL,
  `name` varchar(3000) NOT NULL,
  `percent_change_1h` varchar(3000) NOT NULL,
  `percent_change_24h` varchar(3000) NOT NULL,
  `percent_change_7d` varchar(3000) NOT NULL,
  `price_btc` varchar(3000) NOT NULL,
  `price_usd` varchar(3000) NOT NULL,
  `rank` varchar(3000) NOT NULL,
  `symbol` varchar(3000) NOT NULL,
  `total_supply` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_financial_risk_type`
--

INSERT INTO `remote_user_financial_risk_type` (`id`, `volume_usd_24h`, `available_supply`, `idn`, `last_updated`, `market_cap_usd`, `max_supply`, `name`, `percent_change_1h`, `percent_change_24h`, `percent_change_7d`, `price_btc`, `price_usd`, `rank`, `symbol`, `total_supply`, `Prediction`) VALUES
(1, '1551330000', '96165368', 'ethereum', '1512549553', '43529446198', '0', 'Ethereum', '-0.18', '-3.93', '-7.33', '0.0361767', '452.652', '2', 'ETH', '96165368', 'Risk Found'),
(2, '61647500', '25927070538', 'cardano', '1512549579', '3231420437', '45000000000', 'Cardano', '-0.28', '-5.8', '-8.25', '9.96E-06', '0.124635', '10', 'ADA', '31112483745', 'No Risk Found'),
(3, '409342000', '54153908', 'litecoin', '1512549542', '5634497528', '84000000', 'Litecoin', '-0.17', '0.8', '3.68', '0.00831553', '104.046', '7', 'LTC', '54153908', 'Risk Found'),
(4, '228943000', '7736420', 'dash', '1512549542', '5794075569', '18900000', 'Dash', '1.22', '-3.31', '10.64', '0.0598561', '748.935', '6', 'DASH', '7736420', 'No Risk Found'),
(5, '402067000', '98125659', 'ethereum-classic', '1512549556', '2866554689', '0', 'Ethereum Classic', '-0.2', '-3.47', '-7.7', '0.00233476', '29.2131', '11', 'ETC', '98125659', 'No Risk Found'),
(6, '69659800', '115641028', 'lisk', '1512549553', '1046840406', '0', 'Lisk', '1.06', '-2.52', '15.79', '0.00072349', '9.0525', '18', 'LSK', '115641028', 'No Risk Found');
